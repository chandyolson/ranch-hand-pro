...
const StatCard: React.FC<StatCardProps> = ({ label, value, subtitle, gradientAngle = 145, onClick }) => {
  return (
    <div
      className="rounded-xl px-3 py-2.5 flex flex-col justify-between font-inter"
      style={{
      ...
      {...(onClick ? { className: "rounded-xl px-3 py-2.5 flex flex-col justify-between font-inter cursor-pointer active:scale-[0.97] transition-transform duration-100" } : {})}
    >
