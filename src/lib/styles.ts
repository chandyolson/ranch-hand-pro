...
export const INPUT_CLS =
  "flex-1 h-10 min-w-0 rounded-lg border border-[#D4D4D0] bg-white px-3 text-base outline-none transition-all focus:border-[#F3D12A] focus:ring-2 focus:ring-[#F3D12A]/25";
