...
export default function CalvingRecordScreen() {
  ...
  const record = dbRecord ? {
    ...
    calfTag: dbRecord.calf_tag || (dbRecord as any).calf?.tag || "",
    calfColor: dbRecord.calf_tag_color || (dbRecord as any).calf?.tag_color || "Yellow",
    calfColorHex: TAG_COLOR_HEX[dbRecord.calf_tag_color || (dbRecord as any).calf?.tag_color || "Yellow"] || "#F3D12A",
    calfEid: "",
